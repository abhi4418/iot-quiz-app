export const sampleQuizData = [
  ...
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. The integration of existing devices, smart devices, and constrained nodes in a singular framework is one of the reasons for the address crunch in IoT."
  },
  {
    ...
    "correct": "False",
    "explanation": "The statement is false. In multi-homing, a node/network is connected to multiple networks for improved reliability, not a single network."
  },
  {
    ...
    "explanation": "Both proxy-based approach and gateway-based approach are approaches for multi-homing."
  },
  {
  ...
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. The parameters sensed by a sensor may be sent to the cloud for further processing."
  },
  {
    ...
    "correct": "128",
    "explanation": "IPv6 notation uses 128 bits to represent an address."
  },
  {
    ...
    "correct": "Both (a) and (b)",
    "explanation": "A sensor is both sensitive to the measured property and insensitive to any other property than what the sensor is made to sense."
  },
  {
    ...
    "correct": "None of these",
    "explanation": "We classify sensors based on neither output nor data type."
  },
  {
    ...
    "correct": "All of these",
    "explanation": "All the statements are correct: controlling AC loads using low DC signals, relays are electromechanical, and relays are actuators."
  },
  {
    ...
    "correct": "Both (a) and (b)",
    "explanation": "Based on the output, sensors are classified as both analog and digital."
  },
  {
  ...
  },
  {
    ...
    "correct": "Data",
    "explanation": "Based on functionality, MQTT is a data protocol."
  },
  {
    ...
    "correct": "Both (a) and (b)",
    "explanation": "MQTT is designed for both remote connections and limited bandwidth."
  },
  {
    "question": "MQTT protocol follows which paradigm for exchanging messages?",
    "options": [
      "Client-Server",
      "Publish-Subscribe",
      "Both (a) and (b)",
    ...
    "correct": "Publish-Subscribe",
    "explanation": "MQTT protocol follows the Publish-Subscribe paradigm for exchanging messages."
  },
  {
    ...
    "correct": "False",
    "explanation": "The statement is false. In MQTT, the subscribers are not necessarily lightweight sensors."
  },
  {
    ...
    "correct": "None of these",
    "explanation": "None of these are MQTT components."
  },
  {
    ...
    "correct": "False",
    "explanation": "The statement is false. A topic in MQTT can be any string, not just numbers."
  },
  {
    ...
    "correct": "False",
    "explanation": "The statement is false. There are more than two methods specified by the MQTT protocol."
  },
  {
    ...
    "correct": "Event",
    "explanation": "The Publish/Subscribe architecture in MQTT is event driven."
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. The topic is the routing information for the broker in MQTT."
  },
  {
    ...
    "correct": "Both (a) and (b)",
    "explanation": "CoAP is both based on HTTP and designed for M2M applications."
  },
  {
    ...
    "correct": "UDP",
    "explanation": "In CoAP, client-server interaction is asynchronous over UDP (User Datagram Protocol)."
  },
  {
  ...
  },
  {
    ...
    "correct": "9",
    "explanation": "AMQP has 9 number of frame types."
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. The OSI model has 7 layers."
  },
  {
    ...
    "correct": "Neither (a) nor (b)",
    "explanation": "The “Destination Address” in the IPv4 packet represents neither the source node address of the packet nor the intermediate hop in the network."
  },
  {
    "question": "State True or False.\nStatement: “WirelessHART is the latest release of Highway Addressable Remote Transducer protocol.”",
    "options": [
      "True",
      "False"
    ],
    "correct": "True",
    "explanation": "The statement is true. WirelessHART is the latest release of Highway Addressable Remote Transducer protocol."
  },
  {
    ...
    "correct": "False",
    "explanation": "The statement is false. Wired HART does not have a network layer."
  },
  {
    ...
    "correct": "False",
    "explanation": "The statement is false. WirelessHART physical layer is not derived from 802.15.2 protocol."
  },
  {
    ...
    "correct": "2.4",
    "explanation": "WirelessHART operates only in 2.4 GHz ISM band."
  },
  {
    ...
    "correct": "networked",
    "explanation": "HART standard was developed from networked smart field devices."
  },
  {
    ...
    "correct": "Network",
    "explanation": "Main difference between wired and unwired versions is in the physical, data link, and network layers."
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. Collision free and deterministic communication is achieved in HART’s data link layer."
  },
  {
    ...
    "explanation": "Channel hopping is incorporated in the data link layer of HART."
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. The HART application layer is responsible for extracting commands from a message, executing it and generating responses."
  },
  {
  ...
  },
  {
    ...
    "explanation": "Passive NFC devices contain information which is read by other devices."
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. NFC devices work on the principle of magnetic induction."
  },
  {
    ...
    "correct": "None of these",
    "explanation": "Bluetooth technology is not based on HART or ZigBee."
  },
  {
    "question": "State whether the following statement is true or false.\nStatement: The Link Manager Protocol in Bluetooth manages the only establishment and authentication.",
    "options": [
      "True",
      "False"
    ],
    "correct": "False",
    "explanation": "The statement is false. The Link Manager Protocol in Bluetooth manages not only establishment and authentication but also other functions."
  },
  {
    ...
    "correct": "None of these",
    "explanation": "Zigbee commonly uses a data rate of 250 kbps."
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. In “AID”, a set of sensor nodes are deployed over an agricultural field."
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. Ultrasonic sensor senses the distance at which an object is located."
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. In case of static sensors, where to deploy and/or activate sensors in WSN is a coverage problem."
  },
  {
    ...
    "correct": "False",
    "explanation": "The statement is false. The objective of coverage in WSN is to use minimum number of sensors and maximize network lifetime."
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. A crossing is covered if it is in the interior of at least one node’s coverage disk."
  },
  {
    ...
    "correct": "Both (a) and (b)",
    "explanation": "Both statements are correct: topology cannot be changed automatically and node failure may result in partition of networks."
  },
  {
    ...
    "correct": "None of these",
    "explanation": "Most problems in static WSN can be classified as coverage problems."
  },
  {
    ...
    "correct": "Both (a) and (b)",
    "explanation": "Both statements are correct: UAV networks are multi-tasking and have large coverage area."
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. UAV networks are scalable."
  },
  {
    ...
    "correct": "Both (a) and (b)",
    "explanation": "Both statements are correct: Data Mules collect the data from sensor nodes and go to the sink to deliver the collected data."
  },
  {
  ...
  },
  {
    ...
    "explanation": "This paradigm of sensing is known as Human Centric Sensing."
  },
  {
    ...
    "correct": "False",
    "explanation": "The statement is false. Energy of Devices and Participant selection are two major problems in Human Centric Sensing."
  },
  {
    ...
    "correct": "Star",
    "explanation": "The network topology used in UAV networks is Star."
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. The M2M Application Platform provides integrated services based on device collected data-sets."
  },
  {
    ...
    "correct": "Both (a) and (b)",
    "explanation": "Both statements are correct: large scale of co-operation and global heterogeneity are current challenges in IoT."
  },
  {
    ...
    "correct": "False",
    "explanation": "The statement is false. Interoperability is a characteristic of a product or system."
  },
  {
    ...
    "correct": "Both (a) and (b)",
    "explanation": "Interoperability is required because there are different programming languages and different communication protocols."
  },
  {
    ...
    "correct": "True",
    "explanation": "The statement is true. Use of different programming languages such as JavaScript, Python, JAVA, and others is an example of heterogeneity in IoT. This brings in the need for interoperability."
  },
  {
    ...
    "correct": "False",
    "explanation": "The statement is false. The interoperability between devices and device users in terms of message formats is not called Systematic Interoperability."
  },
  {
    ...
    "correct": "None of these",
    "explanation": "The full form of UMB in IoT interoperability is not Universal Meta Bridge, Universal Main Bridge, or Universal Main Bracket."
  },
  {
  ...
  },
  {
    ...
    "correct": "Multi-sensor deployment",
    "explanation": "Combining information from multiple sensor sources refers to Multi-sensor deployment."
  },
  {
    ...
    "correct": "Belief function",
    "explanation": "One of the theory of evidence-based mathematical methods of data fusion is Belief function."
  },
  {
    ...
    "correct": "Yes",
    "explanation": "Yes, outlier data presents with a challenge with respect to data fusion from multiple IoT sensors."
  },
  {
  ...
  },
  {
    ...
    "correct": "Median",
    "explanation": "The effect size for determining statistical significance is the standardized median difference between two groups."
  },
  {
