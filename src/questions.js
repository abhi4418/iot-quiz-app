...
},
{
  ...
  explanation: "IoT evolved from low-power embedded systems, cloud computing, and networking."
},
{
  question: "Which of the following are the enables of IoT?",
  options: ["RFID", "Nanotechnology", "Sensors", "All of these"],
  correct: "All of these",
  explanation: "RFID, nanotechnology, and sensors all enable IoT."
},
{
  ...
  explanation: "IoT LANs are for local, short-range communication."
},
{
  ...
  options: ["True", "False"],
  correct: "True",
  explanation: "Combining many device types increases the need for unique addresses."
},
{
  ...
  options: ["True", "False"],
  correct: "False",
  explanation: "Multi-homing means connecting to multiple networks for reliability."
},
{
  ...
  correct: "Both (a) and (b)",
  explanation: "Both proxy-based and gateway-based approaches are used."
},
{
...
},
{
  ...
  options: ["False", "True"],
  correct: "True",
  explanation: "Sensor data is often sent to the cloud for processing."
},
{
...
},
{
  ...
  correct: "Both (a) and (b)",
  explanation: "A sensor detects only its target property and ignores others."
},
{
  question: "We classify sensors based on -",
  options: ["Output", "Data type", "Both (a) and (b)", "None of these"],
  correct: "None of these",
  explanation: "Sensors are classified by other criteria."
},
{
  ...
  correct: "All of these",
  explanation: "All statements describe relays."
},
{
...
},
{
  ...
  correct: "Both (a) and (b)",
  explanation: "CoAP is based on HTTP and designed for M2M applications."
},
{
  ...
  correct: "UDP",
  explanation: "CoAP uses UDP for asynchronous client-server interaction."
},
{
...
},
{
  ...
  options: ["6", "3", "5", "9"],
  correct: "9",
  explanation: "AMQP defines nine frame types."
},
{
...
},
{
  ...
  options: ["True", "False"],
  correct: "True",
  explanation: "WirelessHART is the latest release of Highway Addressable Remote Transducer protocol."
},
{
  question: "State True or False. Statement: ‘Wired HART has a network layer.’",
  options: ["True", "False"],
  correct: "False",
  explanation: "Wired HART does not have a network layer."
},
{
  question: "State true or false: ‘WirelessHART physical layer is derived from 802.15.2 protocol’",
  options: ["False", "True"],
  correct: "False",
  explanation: "WirelessHART physical layer is derived from 802.15.4 protocol, not 802.15.2."
},
{
...
},
{
  ...
  options: ["True", "False"],
  correct: "True",
  explanation: "Collision free and deterministic communication is achieved in HART’s data link layer."
},
{
...
},
{
  ...
  options: ["True", "False"],
  correct: "True",
  explanation: "The HART application layer is responsible for extracting commands from a message, executing it and generating responses."
},
{
...
},
{
  ...
  options: ["True", "False"],
  correct: "False",
  explanation: "The Link Manager Protocol in Bluetooth manages not only establishment and authentication but also other functions."
},
{
...
},
{
  ...
  options: ["True", "False"],
  correct: "True",
  explanation: "In “AID”, a set of sensor nodes are deployed over an agricultural field."
},
{
  question: "State True or False. Statement: Ultrasonic sensor senses the distance at which an object is located.",
  options: ["True", "False"],
  correct: "True",
  explanation: "Ultrasonic sensor senses the distance at which an object is located."
},
{
  ...
  options: ["True", "False"],
  correct: "True",
  explanation: "In case of static sensors, where to deploy and/or activate sensors in WSN is a coverage problem."
},
{
  ...
  options: ["True", "False"],
  correct: "False",
  explanation: "The objective of coverage in WSN is to use minimum number of sensors and maximize network lifetime."
},
{
  ...
  options: ["True", "False"],
  correct: "True",
  explanation: "A crossing is covered if it is in the interior of at least one node’s coverage disk."
},
{
...
},
{
  ...
  options: ["True", "False"],
  correct: "True",
  explanation: "UAV networks are scalable."
},
{
  ...
  correct: "Both (a) and (b)",
  explanation: "Data Mules collect the data from sensor nodes and goes to the sink and delivers the collected data."
},
{
...
},
{
  ...
  options: ["True", "False"],
  correct: "False",
  explanation: "Energy of Devices and Participant selection are two major problems in Human Centric Sensing."
},
{
...
},
{
  ...
  options: ["True", "False"],
  correct: "False",
  explanation: "Interoperability is a characteristic of a product or system."
},
{
...
},
{
  ...
  options: ["False", "True"],
  correct: "True",
  explanation: "Use of different programming languages such as JavaScript, Python, JAVA, and others is an example of heterogeneity in IoT. This brings in the need for interoperability."
},
{
  ...
  options: ["True", "False"],
  correct: "False",
  explanation: "The interoperability between devices and device users in terms of message formats is not called Systematic Interoperability."
},
{
...
},
{
  ...
  correct: "Gyroscope",
  explanation: "A gyroscope detects angular tilt or rotation in a device."
}
]